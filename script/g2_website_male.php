...
<?php
  ...
  $filename = '/Users/hou/Desktop/tci/g2_auto/result/male_disease_ratio.csv';
...
<?php
  ...
  //read the disease risk file
  $filename = '/Users/hou/Desktop/tci/g2_auto/result/female_risk_disease.csv';
...
<?php
  ...
  //read the disease risk file
  $filename = '/Users/hou/Desktop/tci/g2_auto/result/nutrient.csv';
...
<?php
  ...
  //read the disease risk file
  $filename = '/Users/hou/Desktop/tci/g2_auto/client_data/client_info.csv';
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>思覺失調屬輕型精神疾病的表面徵狀，一般包含感情障礙（如焦慮、憂鬱等），思想<br>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>攝護腺又稱前列腺，是男性泌尿生殖系統特有的器官。男性隨年齡增長，攝護腺出現<br>
              一種良性增生及肥大現象，大約40歲開始增生、50歲開始出現排尿困難症狀。
          </li>
          <li>良性攝護腺肥大雖然不是癌症，但會引發其他併發症，包括尿道發炎、泌尿道感染、<br>
              泌尿道結石、腎功能不良、性功能障礙等。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>發生在牙周周邊組織的疾病，主因為牙菌斑及牙結石堆積於牙齒或牙根表面，導致局<br>
              部發炎反應，進而造成包括齒槽骨、牙齦等牙齒周邊支持組織破壞，使牙齒逐漸鬆動<br>
              ，最後造成牙齒喪失。
          </li>
          <li>罹患牙周病者得到心肌梗塞與中風的機率是一般人的2~3倍因為牙齦；附近的致病菌<br>
              引發發炎反應釋放的發炎物質，導致血管動脈粥樣硬化病理有所改變，且此些菌可能<br>
              入侵牙齦造成菌血症，影響血小板凝集導致血栓形成，更進而導致中風與心肌梗塞。
          </li>
        </ul>
      </td>
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          ...
          <li>好發年齡以50～70歲佔大多數，男性比女性來得多；但小於40歲的胃癌，女性反多男性<br>
              。地緣分佈方面，台灣的東北部和東部山地鄉鎮是胃癌的高死亡率地區，至於客家鄉鎮<br>
              ，則是死亡率最低的地區。
          </li>
        </ul>
      </td>
   ...
   <div class="disease_title">
      <table class="table_disease_tile">
       ...
       <tr>
         ...
         <td align = "center">
           每十萬人口<br>年齡標準化<br>
           <font size="5" color = "#5DADE2">2.29</font>
           <br>
           <font style = "font-weight: 300;">男性比女性易患
           <br>
           比例約2.7比1
            ...
            <tr>
              <td style="border-right: 1px solid #F7DC6F;">
                <ul style="font-weight: 300;">
                  ...
                  <li>常見的危險因子包含：家族病史、地理區域、遺傳、生活飲食習慣、抽菸、肥胖、糖<br>
                      尿病、性傳染病等。
                  </li>
                </ul>
              </td>
...
<div class = "disease_top">
    ...
    <div class="disease_detail">
     ...
     <div class = "disease_title_last">
          <h1 align = "center" style="font-weight: normal;">綜合高風險疾病</h1>
     </div>


         <div class="disease_detail6">

                 <img src= "../graph/綜合風險評估-removebg.png" alt= "tcigene_logo" align="middle" style="width:300px;height:800px;">
                 ...
                 <table class="high_risk_disease" FRAME="VOID" BORDER="2" RULES="ALL">
                   ...
                   <tr>
                     <th colspan = "3" style="text-align: left">
                       <br>
                       <img src= "../graph/綜合風險icon.png" alt= "tcigene_logo" align="left" style="width:45px;height:45px;">
                       <font size = "5">&nbsp綜合高風險疾病</font>
                       <br><br>
                       <hr>
          ...
          <div class = "disease_title_last">
               <h1 align = "center" style="font-weight: normal;">個人營養評估與生活飲食型態建議</h1>
          </div>
          ...
          <div class="disease_title">
             <table class="table_disease_tile_last">
              ...
              <tr align = "left">
                <td>理想體重: 51～62 公斤</td>
                <td>每日建議熱量: 1530 大卡</td>
                <td>每日建議水量: 1530 c.c.</td>
              </tr>
          ...
          <div class="disease_detail4">
            ...
            <h3><font color = "#5DADE2" size = "6">&nbsp&nbsp&nbsp&nbsp| </font>整體風險評估</h3>
            <p>
              &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        ...
        <div class = "disease_top">
             ...
             <h1 align = "center">大江基因全檢特調建議</h1>

             <h4 align = "center">(全品項皆由大江生醫股份有限公司製造)</h4>
