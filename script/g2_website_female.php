...
<div class = "overview_top">
  ...
  <img src= "../graph/疾病風險頁首右.png" alt= "tcigene_logo" align="middle" style="width:900px;height:100px;">
...
<div class = "overview_top">
  ...
  <img src= "../graph/疾病風險頁首左.png" alt= "tcigene_logo" align="middle" style="width:900px;height:100px;">
...
<div class = "disease_top">
  <br>
  <img src= "../graph/疾病頁首右.png" alt= "tcigene_logo" align="middle" style="width:900px;height:100px;">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          ...
          <li>肥胖者較易罹患高血壓、糖尿病、高血脂症、睡眠呼吸中止症候群、冠狀動脈心臟病<br>
              、腦中風、膽結石及若干癌症，對健康有不良影響。
          </li>
        </ul>
      </td>
...
<div class="disease_detail">
  ...
  <ul style="list-style-type:none; text-align: left; font-weight: 300;">
    ...
    (2)<font color = "red" style = "font-weight: 400;">紅字標示判定為『高風險』基因型</font>。就您個人而言，帶有高風險基因型可能是導致該疾病發生的先天性影響因子，<br>
    &nbsp&nbsp&nbsp&nbsp
    請多加留意。<br>
...
<div class = "disease_top">
  ...
  <img src= "../graph/疾病頁首左.png" alt= "tcigene_logo" align="middle" style="width:900px;height:100px;">
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>糖尿病是一種慢性的代謝異常疾病，主要原因是由於體內胰島素缺乏或功能不全，對<br>
              糖類的利用能力減低，甚至完全無法利用而造成血糖上升。
          </li>

          <li>糖尿病的分類有「胰島素依賴型」和「非胰島素依賴型」，第二型糖尿病屬於後者；<br>
              由於先天體質加上後天環境的因素如：肥胖、缺少運動、壓力等，導致胰島素的分泌<br>
              不足及功能異常。
          </li>
        </ul>
      </td>
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          ...
          <li>數種疾病已被證實和高血壓密切相關：(一)中風 (二)冠狀動脈心臟病 (三)心臟衰竭 <br>
              (四)腎臟病變。
          </li>
        </ul>
      </td>
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          ...
          <li>當血中之總膽固醇和三酸甘油酯，其中之一或兩者皆超過正常值(>200mg/dl)時，即<br>
              稱為高血脂症。
          </li>
          <li>高血脂症除會導致心臟疾病之外，也與腦中風、高血壓、糖尿病、腎病等慢性疾病息<br>
              息相關。
          </li>
        </ul>
      </td>
...
<div class="disease_title" >
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>高尿酸血症是導致痛風的主要因素，有高尿酸血症的病人，未來5-10%的人會發展<br>
              成痛風。
          </li>
          <li>血中尿酸值大於7.0 mg/dL 為高尿酸血症，如果合併某些代謝異常的共病症，如高<br>
              血壓、肥胖、以及高血脂等，將提高痛風的發生率。
          </li>
        </ul>
      </td>
...
<div class="disease_title" >
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>冠狀動脈是輸送血液及氧氣到心臟的血管，當血管狹窄或阻塞造成心臟缺氧的現象即<br>
              屬冠狀動脈疾病；臨床上會出現胸痛或胸悶的症狀，也就是心絞痛或狹心症。
          </li>
...
<div class="disease_title" >
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>心房顫動是一種因為心臟內產生節律訊號的功能異常，導致心跳不規則且經常過快<br>
              的病症。罹患心房顫動可能不會有任何症狀，但也可能會出現心悸、頭暈、疲倦、<br>
              胸悶或喘不過氣等症狀。
          </li>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>腦中風常常是急性發作，是指腦部血管發生病變，以致血管突然破裂(腦內出血)或堵<br>
              塞(腦梗塞)，使腦部功能缺損，若不及時接受有效的醫治，將會導致中至重度殘障。
          </li>
          <li>2018年腦中風佔台灣地區死亡原因的第四位。中風後患者之肢體殘障及言語問題，需<br>
              人長期照顧，是成人殘障的第一號殺手。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>靜脈曲張為靜脈血管受到非正常血液的長期壓迫，造成管內瓣膜功能受損，使得血管<br>
              內積壓過量血液，導致血管壁變薄及血管突出。外部表現通常為突出的靜脈，內部表<br>
              現為血栓的形成。為不可恢復的反應。
          </li>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>阿茲海默症是最常見的失智症，是一種不可逆、漸進性中樞神經退化的腦部疾病。由<br>
              於疾病的成因至今尚未完全明白，目前的治療只能延緩退化速度，並無法治癒。
          </li>
          <li>絕大多數的阿茲海默症屬於晚發型，通常發生在65歲以後，發病初期會有注意力無法<br>
              集中、早醒、短期記憶力退化現象，持續進展則出現智力退化、認知退化、失去生活<br>
              能力、死亡。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>帕金森氏症是老年人的三大腦病之一，通常患者是在50~60歲發病，而診斷時的平均<br>
              年齡是60歲。<br>
          </li>
          <li>帕金森氏症是一種慢性的中樞神經系統退化性失調，它會損害患者的動作技能、語言<br>
              能力以及其他功能。主要症狀有：(一)四肢顫抖 (二)四肢僵硬 (三)動作遲緩，這種病<br>
              症會逐漸惡化，大約五到十年內可能會殘障。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>退化性關節炎是人類關節疾病中最普遍的一種，跟年齡老化有直接的關聯。主要的症<br>
              狀是疼痛、僵硬、腫大和變形，在活動關節時，常可聽到不正常的摩擦聲響。
          </li>
          <li>較早期的症狀包含膝部酸痛無力，硬緊不靈活，蹲下後不易站起來。症狀加重時，則<br>
              出現蹲下疼痛有困難，膝關節漸變形無法走遠路，夜裏睡覺時膝部會酸痛，步態左右<br>
              搖擺，需要他人幫忙。
          </li>
        </ul>
      </td>
 ...
 <div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>骨質疏鬆症為一種全身骨骼疾病，其特徵包含骨量減少、骨組織的顯微結構變差，造<br>
              成骨骼脆弱，骨折危險性增高。目前臨床上主要根據骨密度測量值診斷骨質疏鬆症。
          </li>
          <li>骨質疏鬆症多數情況下並不會直接導致死亡，但發生骨折機會提高，從而影響病患的<br>
              健康和獨立生活的能力。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>肌少症顧名思義，即為骨骼肌的流失，被認為是老年病症候群的表現之一。
          </li>
          <li>肌少症患者在生理與疾病上有許多不良影響，包含失能、較差的下肢功能、代謝症<br>
              候群、心血管風險等。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>子宮內膜異位症就是子宮內膜細胞生長在子宮腔以外的地方，例如骨盆腔內的腹膜、<br>
              卵巢和膀胱等。
          </li>
          <li>子宮內膜異位症是女性經痛的主要原因之一，且對婦女懷孕率有相當不良的影響。患<br>
              者常因經痛或不孕的問題，容易出現憂鬱症的現象。
          </li>
        </ul>
      </td>
      ...
      <td align = "center">
          <font style = "font-weight: 400;">所有婦女中</font>
          <br>
          <font size="6" color = "#5DADE2">6~10%</font>
      </td>
...
<div class="disease_detail">
  ...
  <table class="table_disease_detail" FRAME="VOID" BORDER="2" RULES="ALL" style="display:inline-table;">
    ...
    <tr align="center">
      ...
      <td style="font-weight: 300;">IL1A-1</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
     ...
     <tr align = "center">
      <td style="font-weight: 300;">IL1A-3</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
     ...
     <tr align = "center">
      <td style="font-weight: 300;">IL1A-4</td>
      <td>
        <font color = "#9d9e9e">
          AA
        </font>
    ...
    <tr align = "center">
      <th rowspan = "5">
        <ul style="list-style-type:none; text-align: left">
          <li style="font-weight: 400;">細胞生長調控：<li>
          <li style="font-weight: 100;">
              帶有高風險基因型在調控細胞生長的機<br>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">ZYG11B</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">CDKN2BAS</td>
      <td>
        <font color = "#9d9e9e">
          AA
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">BTBD9</td>
      <td>
        <font color = "#9d9e9e">
          GG
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">ANKFN1</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
     ...
     <tr align = "center">
      <th rowspan = "1">
        <ul style="list-style-type:none; text-align: left">
          <li style="font-weight: 400;">雌激素活性調節：<li>
          <li style="font-weight: 100;">
              帶有高風險基因型可能因持續性的雌激<br>
      ...
      <td style="font-weight: 300;">WNT4</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>子宮肌瘤就是子宮長有肉瘤，是婦科最常見的一種良性腫瘤，惡性的比例不到百分之<br>
              一，多數人的症狀並不明顯。
          </li>
          <li>臨床最常見的症狀是月經量增加，還可能會有骨盆腔的慢性疼痛，例如：痛經、性交<br>
              疼痛等；若是肌瘤太大，壓迫到泌尿系統，可能造成頻尿、解尿困難，或是腎積水；<br>
              壓迫到腸子，則可能造成阻塞或便秘。
          </li>
        </ul>
      </td>
      ...
      <td align = "center">
        <font style = "font-weight: 400;">生育年齡婦女</font>
        <br>
        <font size="6" color = "#5DADE2">20%</font>
        <br>
        <font style = "font-weight: 400;">40歲以上的婦女</font>
        <br>
        <font size="6" color = "#5DADE2">40~50%</font>
      </td>
...
<div class="disease_detail">
  ...
  <table class="table_disease_detail" FRAME="VOID" BORDER="2" RULES="ALL" style="display:inline-table;">
    ...
    <tr align = "center">
      <td style="font-weight: 300;">PDCD6-1</td>
      <td>
        <font color = "#9d9e9e">
          GG
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">PDCD6-2</td>
      <td>
        <font color = "#9d9e9e">
          CC
        </font>
     ...
     <tr align = "center">
      ...
      <td style="font-weight: 300;">AIRE</td>
      <td>
        <font color = "#9d9e9e">
          CC
        </font>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>多囊性卵巢症候群從超音波可看到卵巢腫大，卵巢出現許多小的卵泡看起來像是小囊<br>
              腫，是生殖年齡婦女最為常見的內分泌疾病。
          </li>
          <li>常見的症狀包含月經稀少、肥胖、不孕症、與男性荷爾蒙太高的表現，例如：多毛症<br>
              ，青春痘很多等。
          </li>
        </ul>
      </td>
...
<div class="disease_detail">
  ...
  <table class="table_disease_detail" FRAME="VOID" BORDER="2" RULES="ALL" style="display:inline-table;">
    ...
    <tr align="center">
      ...
      <th rowspan = "6">
        <ul style="list-style-type:none; text-align: left">
          <li style="font-weight: 400;">參與性荷爾蒙的分泌調節：<li>
          <li style="font-weight: 100;">
              負責促性腺激素釋放激素(GnRH)、黃體<br>
      ...
      <td style="font-weight: 300;">LHCGR-<br>STON1-<br>GTF2A1L</td>
      <td>
        <font color = "#9d9e9e">
          GG
        </font>
     ...
     <tr align = "center">
      <td style="font-weight: 300;">YAP1</td>
      <td>
        <font color = "#9d9e9e">
          AA
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">C9orf3-1</td>
      <td>
        <font color = "#9d9e9e">
          AA
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">C9orf3-2</td>
      <td>
        <font color = "#9d9e9e">
          AA
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">FSHR-1</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">FSHR-2</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
    ...
    <tr align = "center">
      <th rowspan = "4">
        <ul style="list-style-type:none; text-align: left">
          <li style="font-weight: 400;">影響胰島素或胰島素敏感性：<li>
          <li style="font-weight: 100;">
              帶有高風險基因型易發生胰島素阻抗現<br>
      ...
      <td style="font-weight: 300;">THADA-1</td>
      <td>
        <font color = "#9d9e9e">
          CC
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">THADA-2</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">SUOX</td>
      <td>
        <font color = "#9d9e9e">
          AA
        </font>
     ...
     <tr align = "center">
      <td style="font-weight: 300;">HMGA2</td>
      <td>
        <font color = "#9d9e9e">
          CC
        </font>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>女性尿道感染發生主因為女性的尿道較短(五公分)，且尿道口接近陰道口及肛門，衛<br>
              生環境不注意時，細菌容易感染至膀胱或逆流至腎臟造成感染。另外孕婦更容易得到<br>
              女性尿道感染，因懷孕時子宮及胎兒會漸漸壓迫膀胱，如尿中有細菌的情形，就容易<br>
              引起尿道感染。更年期陰道上皮細胞萎縮，好菌(乳酸桿菌)不易繁殖，陰道無法維持<br>
              酸鹼度，致使容易有細菌附著在生殖泌尿道口。因此女性尿道感染，反覆發生很常見。
          </li>
      ...
      <td align = "left">
        <font style = "font-weight: 400;">&nbsp&nbsp&nbsp&nbsp少女約為 </font>
        <font size="5" color = "#5DADE2">2%</font>
        <br>
        <font style = "font-weight: 400;">&nbsp&nbsp&nbsp&nbsp婚後女性約為 </font>
        <font size="5" color = "#5DADE2">5%</font>
        <br>
        <font style = "font-weight: 400;">&nbsp&nbsp&nbsp&nbsp七十歲之後女性尿道感染</font>
        <br>
        <font style = "font-weight: 400;">&nbsp&nbsp&nbsp&nbsp之盛行率約增加至  </font>
...
<div class="disease_detail">
  ...
  <table class="table_disease_detail" FRAME="VOID" BORDER="2" RULES="ALL" style="display:inline-table;">
    ...
    <tr align="center">
      ...
      <th rowspan = "3">
        <ul style="list-style-type:none; text-align: left">
          <li style="font-weight: 400;">免疫抵抗能力：<li>
          <li style="font-weight: 100;">
              影響免疫細胞對抗病源菌誘發的免疫反<br>
      ...
      <td style="font-weight: 300;">IL6</td>
      <td>
        <font color = "#9d9e9e">
          GG
        </font>
     ...
     <tr align = "center">
      <td style="font-weight: 300;">TLR5</td>
      <td>
        <font color = "#9d9e9e">
          GG
        </font>
 ...
 <div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>類風濕性關節炎，是一種由自身免疫障礙引致免疫系統攻擊自己體內的正常組織，通<br>
              常是從關節組織開始侵犯，尤其是手部關節。
          </li>
          <li>長期的慢性炎症會造成關節變形直至殘廢，並會因關節痛楚及磨損而失去部分的活動<br>
              能力。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>是一種慢性發炎性疾病，可能侵犯皮膚、關節、腎臟、肺臟、神經系統及其他器官<br>
              或系統，任何年齡的人都可能得到紅斑性狼瘡，但通常發生於20~40歲年輕女性。
          </li>
          <li>以發生的頻率來說，約90%以上的人會關節痛或關節炎，70~80%的人有皮膚紅斑或<br>
              盤狀紅斑，40~50%有肋膜炎或心包膜炎，40~50%的患者會發生狼瘡腎炎，20~60%<br>
              患者有中樞神經侵犯，約60%患者有白血球低下，20%患者有血小板低下。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>是由血液中不正常的高濃度抗甲狀腺抗體，造成甲狀腺細胞發炎破壞，病程及嚴重程<br>
              度因人而異。發病早期大部分病人症無症狀，少數會出現甲狀腺功能亢進，晚期約10%<br>
              患者會出現甲狀腺功能低下，影響全身器官。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>是一種慢性全身性疾病，臨床症狀是背痛、僵硬和疲勞，有些病患症狀會好，有些<br>
              有持續性脊椎疾病和脊椎以外症狀，例如眼睛虹膜炎、心瓣膜炎、心傳導系統障礙<br>
              、大動脈瓣膜炎...等。好發於男性20歲至40歲比例高於女性，且男性之脊椎病變較<br>
              嚴重。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>肝臟細胞、組織及血管受到病毒、酒精或其它因素破壞，使肝臟產生纖維化及結節，<br>
              稱為肝硬化。肝硬化是不可逆的，除非是接受肝臟移植，否則情形是無法好轉。
          </li>
          <li>肝硬化可怕的地方在於它的併發症：食道靜脈曲張、肝昏迷(肝性腦病變)、腹水(有<br>
              時併發腹膜炎)，同時肝硬化的病人，有機會會轉變成為肝癌。
          </li>
          <li>造成肝硬化的原因，在台灣以B型肝炎及C型肝炎為主要元凶，尤其B肝約佔70~80%，<br>
              C肝約佔10~20%。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>肝臟內的脂肪過量堆積。當經常攝入過量的高脂飲食或當肝細胞受損傷(如藥物、嗜<br>
              酒、病毒性肝炎等引起)而不能夠發揮正常脂肪的代謝功能時，使肝細胞內的脂肪儲<br>
              量逐漸增多，形成脂肪肝。
          </li>
          <li>一般的脂肪肝大都屬於良性疾病，不會引起肝硬化或肝癌，但若長期酗酒引起的脂肪<br>
              肝，則會使肝臟受損，最後仍可能發展成肝硬化。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>膽石症是包含結石發生在肝內膽管或膽囊或膽總管，是最常見的膽道疾病。
          </li>
          <li>膽結石可能無症狀，但也可能會引發不適，初始症狀會產生上腹部的發脹、噁心、嘔<br>
              吐等現象，發作時則是劇烈的上腹部疼痛、黃疸，有時會有發燒症狀。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>消化性潰瘍屬於慢性、具復發性的疾病，主要包含十二指腸潰瘍及胃潰瘍，上腹疼痛<br>
              是最常見的臨床症狀。
          </li>
          <li>胃食道逆流是因胃食道和胃部上方連接處的賁門無法正常運作，導致胃酸、消化酵素<br>
              和胃裡面的食物逆流到食道，造成食道黏膜發炎。典型的症狀有心口灼熱感(火燒心)<br>
              、胃酸逆流感(溢酸)。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>息肉是一個生長在大腸之腸壁內的腫瘤組織，有些息肉（例如：增生性息肉）不會變<br>
              成癌症，但是有些息肉（例如：腺性息肉）會變成癌症。大部分的大腸直腸息肉是沒<br>
              有症狀的，偶爾會有腹痛、大便習慣改變、便血或便秘等非特異性的症狀。
          </li>
          <li>腺性息肉發生癌化情形與息肉大小及形狀及家族史有關，息肉一旦有病理變化或已有<br>
              早期癌化即需切除。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>可分為急性胰臟炎與慢性胰臟炎。疾病發生原因包含阻塞性、酒精性、藥物、抽煙、<br>
              代謝性、外傷性、感染性、懷孕、家族遺傳、自體免疫及其他不明性原因。慢性胰臟<br>
              炎嚴重時可能併發胰臟癌。
          </li>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>白內障是因水晶體混濁，導致視力障礙的一種疾病。最常見的白內障是因老化形成，<br>
              年齡是最重要的單一危險因子。女性比男性更常罹患白內障。
          </li>
          <li>白內障早期的症狀可能有視力模糊、色調改變、怕光、眼前黑點、複視、晶體性近視<br>
              等，晚期症狀則為視力障礙日深，最後只能在眼前辨別手指或僅剩下光覺視力。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>青光眼是一群有很多不同病因所造成的疾病，共同特徵是視神經萎縮和視野缺損，病<br>
              理性的眼壓升高是最重要的危險因素之一。
          </li>
          <li>慢性青光眼的病人往往沒有自覺症狀，等到病人發覺視力降低時，多半已經是末期，<br>
              已經萎縮的視神經是無法再生回復，任何治療都只是讓視力不要再惡化，或惡化的慢<br>
              一點，但視力不會有任何進步。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>黃斑部病變是一種隨年齡增長，逐漸出現網膜中央部位退化的疾病。視覺上漸次出現<br>
              視物扭曲變形、變大或變小、視力模糊，最終造成視力喪失。
          </li>
          <li>年齡與基因遺傳是病情惡化的兩大高危險因子，流行病學的調查發現，抽煙的人罹病<br>
              機會是不抽煙者的2至5倍。
          </li>
        </ul>
      </td>
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          ...
          <li>高度近視代表眼睛提早老化，因此容易併發視網膜剝離、黃斑部退化或是白內障等眼<br>科疾病。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>憂鬱症是一種涉及身體、情緒和思想的疾病。它會影響患者的飲食和睡眠、對自己的<br>
              感覺以及看待事情的方式，包含無用、無助和絕望。憂鬱症並不同於暫時的情緒低落<br>
              ，如果不進行治療，症狀可以持續數週、數月或是數年。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>躁鬱症，又稱躁狂憂鬱症，是一種可能引起患者情緒、精力及功能不穩定的大腦失調<br>
              症，患者情緒高低交替起伏，有時情緒高昂、有時低落。
          </li>
          <li>躁鬱症發病時出現的精神狀況會對個人的人際關係有所影響，工作或學習狀態不佳，<br>
              甚至自殺，後果非常嚴重。患者若接受有效治療，可以恢復健康豐富的生活，如不接<br>
              受治療，病情則會惡化。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>思覺失調屬輕型精神疾病的表面徵狀，一般包含感情障礙（如焦慮、憂鬱等），思維<br>
              障礙（如強迫觀念等）。思覺失調症的病徵有幻覺、妄想、心理障礙、注意力不足、<br>
              反應緩慢和胡言亂語的症狀，影響其日常生活。
          </li>
          <li>思覺失調症患者中斷治療的復發率極高，若9個月後中斷治療，復發機率約7成；2年<br>
              內沒有持續治療，復發機率高達9成。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>慢性阻塞性肺病是一種呼吸氣流受阻，而且無法以藥物完全恢復之疾病，通常是漸進<br>
              式惡化。在全世界死亡原因中，慢性阻塞性肺病為第四位。
          </li>
          <li>患者常會出現急性惡化，主要症狀為呼吸變得更困難，常伴有喘鳴和胸悶、痰量和咳<br>
              嗽次數增加、痰的黏稠度及顏色改變和發燒。上呼吸道感染和空氣污染是惡化常見原<br>
              因。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>腎結石是尿液中的礦物質結晶沈積在腎臟裡，有時會移動到輸尿管。較小的腎結石常<br>
              會隨尿液排出體外，但如果直徑增加到可能堵住輸尿管，造成尿液受阻，引起劇烈腰<br>
              痛，有時疼痛會延伸到下腹部或腹股溝。若結石卡在輸尿管進入膀胱處，則病人經常<br>
              有解尿困難，頻尿等類似泌尿道感染的情形出現。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>腎衰竭可分為急性腎損傷和慢性腎臟病。急性腎損傷只要經過適當的治療就可能痊癒<br>
              ，而慢性腎臟病則為不可修復損傷。
          </li>
          <li>腎功能衰竭時，體內的廢液可能難以排除，會導致腫脹、酸血症、高鉀血症、低血鈣<br>
              、高血磷症，和貧血，骨骼的健康也可能會被影響。長期的腎臟病也提高了心血管疾<br>
              病的機率。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>氣喘病是一種慢性的呼吸道發炎疾病，在臨床上大致可分為非過敏原引起的及過敏原<br>
              引起的兩種。
          </li>
          <li>氣喘依嚴重程度，會出現呼吸困難、喘鳴、胸悶和咳嗽等症狀，部分氣喘病人還有多<br>
              痰現象。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>濕熱環境，加上溫差大、人口密集，且空氣污染嚴重易有過敏性鼻炎產生。是一種患<br>
              者的過敏體質或環境因素影響所形成的呼吸道慢性炎症反應，嚴重者會變成鼻竇炎。
          </li>
          <li>過敏原檢測與保持室內通風的環境，盡量避免生冷飲食、多運動、維持規律健康的生<br>
              活，都有機會降低症狀與發生率。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>過敏性疾病之一，與基因以及環境有很大的關聯。因皮膚障壁有顯著異常，造成外界<br>
              過敏原/刺激物容易穿透皮膚，進而刺激皮膚發炎。
          </li>
          <br><br><br>
        </ul>
      </td>
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          ...
          <li>乾癬除發生於皮膚外，有相當比例會造成關節疾患(乾癬性關節病變)，另外50%的病<br>
              人手指甲及35%病人的腳趾甲會被乾癬侵犯，產生指甲凹陷、黃斑、嚴重變形等。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>發生在牙齒周邊組織的疾病，主因為牙菌斑及牙結石堆積於牙齒或牙根表面，導致局<br>
              部發炎反應，進而造成包括齒槽骨、牙齦等牙齒周邊支持組織破壞，使牙齒逐漸鬆動<br>
              ，最後造成牙齒喪失。
          </li>
          <li>罹患牙周病者得到心肌梗塞與中風的機率是一般人的2~3倍；因牙周附近的致病菌引<br>
              發發炎反應釋放的發炎物質，導致血管動脈粥樣硬化病理有所改變，且此些菌可能入<br>
              侵牙齦造成菌血症，影響血小板凝集導致血栓形成，更進而導致中風與心肌梗塞。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>癌症與基因遺傳有關，然而，倘若缺少外界環境致癌因子，則這些致癌基因很可能根<br>
              本不會表現出來，亦即不會有口腔癌的發生。
          </li>
          <li>在歐美地區，以抽煙及喝酒為主要致病因子；但在台灣及印度，以嚼檳榔為主要致病<br>
              因子的地區。
          </li>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>鼻咽癌好發於中國東南沿海各省(尤其是廣東裔)聚集之地區如新加坡、香港、台灣等<br>
              地。
          </li>
          <li>主要原因約有三項，即遺傳因子、EB病毒感染、以及環境因素（食用過多醃漬食物或<br>
              鹹魚、工作環境之有機溶劑空氣污染及吸菸者等）。
          </li>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>危險因子包含:遺傳、吸菸與喝酒、營養不良、先前存在的食道疾病、硝胺、社會經<br>
              濟因素等。
          </li>
        </ul>
      </td>
...
<div class="disease_detail">
  ...
  <div class="disease_detail_outer3">
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>危險因子包含：吸菸與油煙、家族病史、空氣污染、肺結核及其他慢性疾病、石棉暴<br>
              露因素等。
          </li>
        </ul>
      </td>
...
<div class="disease_detail">
  ...
  <div class="disease_detail_outer4">
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>常見的危險因子包含：遺傳、年紀50歲以上、A型血型、燒烤食物、醬菜鹹魚等鹽漬高<br>
              鹽分食物、醃製食物、吸菸與酒精濫用、胃部相關其他疾病、以及幽門螺旋桿菌導致之<br>
              嚴重胃炎等。
          </li>
          <li>好發年齡以50～70歲佔大多數，男性比女性來得多；但小於40歲的胃癌，女性反多於男<br>
              性。地緣分佈方面，台灣的東北部和東部山地鄉鎮是胃癌的高死亡率地區，至於客家鄉<br>
              鎮，則是死亡率最低的地區。
          </li>
        </ul>
      </td>
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          ...
          <li>常見的危險因子包含：肝炎病毒(B型與C型病毒感染)、喝酒、抽煙、嚼食檳榔、食用<br>
              含黃麴毒素的發霉過後黃豆、玉米、花生、小麥及五穀雜糧類，遺傳基因等。
          </li>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>在歐美大腸癌好發在40~50歲以上，而台灣卻有年輕化的趨勢，朝向20~30歲罹癌。
          </li>
          <li>常見的危險因子包含：飲食習慣(高熱量、高脂肪、多紅肉、低纖維)、酗酒與抽煙、<br>
              家族遺傳、個人大腸相關疾病、缺乏運動等。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>胰臟癌早期症狀不明顯，且缺乏特異性的表現和敏感的診斷指標，早期診斷極為困難<br>
              ，因此治療效果較不佳且癒後較差。
          </li>
          <li>造成胰臟癌的確切原因至今仍不明確，常見的危險因子包含：酗酒與抽煙、家族遺傳<br>
              、糖尿病、肥胖症、慢性胰臟癌、環境接觸工業有機溶劑與飲食習慣(蔬菜及水果攝<br>
                取不足、紅肉或高熱量的食物攝取過量)等。
          </li>
        </ul>
      </td>
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          ...
          <li>常見的危險因子包含：家族遺傳、荷爾蒙與未曾生育或35歲以後才生第一胎者、良性<br>
              乳房瘤、肥胖者、輻射線的暴露、長期接受荷爾蒙(替代)治療者，缺乏運動與酗酒等。
          </li>
        </ul>
      </td>
      ...
      <td align = "center">
        每十萬人口<br>年齡標準化<br>
        <font style = "font-weight: 300;">女性 </font>
        <font size="6" color = "#5DADE2">72.99</font>
      </td>
...
<div class="disease_detail">
  ...
  <table class="table_disease_detail2" FRAME="VOID" BORDER="2" RULES="ALL" style="display:inline-table;">
    ...
    <tr align = "center">
      <td style="font-weight: 300;">RAD51L1</td>
      <td>
        <font color = "#9d9e9e">
          GG
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">BRCA1</td>
      <td>
        <font color = "#9d9e9e">
          GG
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">BRCA2</td>
      <td>
        <font color = "#9d9e9e">
          AA
        </font>
    ...
    <tr align = "center">
      ...
      <td style="font-weight: 300;">IL23</td>
      <td>
        <font color = "#9d9e9e">
          CC
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">MAP3K1</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">IL-17A</td>
      <td>
        <font color = "#9d9e9e">
          GG
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">ABCB1</td>
      <td>
        <font color = "#9d9e9e">
          GG
        </font>
      ...
      <td align = "center">
        ...
        <br><br><br><br>
        <hr>
        <p style="font-weight: 300;" align = "center">70</p>
...
<div class="disease_detail2">
  ...
  <table class="table_disease_detail" FRAME="VOID" BORDER="2" RULES="ALL" style="display:inline-table;">
    ...
    <tr align="center">
      <th class = "table_disease_detail_firstcol" rowspan = "7" style="font-weight: 400;">
        ...
        <th rowspan = "1">
          <ul style="list-style-type:none; text-align: left">
            <li style="font-weight: 400;">影響脂肪代謝能力：</li>
            <li style="font-weight: 100;">
              帶有高風險基因型易發生脂質代謝異常<br>
              ，使膽固醇及三酸甘油酯過量累積。
            </li>
        </ul>
      </th>
     ...
     <tr align = "center" >
      ...
      <td style="font-weight: 300;">HUNK</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">FGFR2-1</td>
      <td>
        <font color = "#9d9e9e">
          AA
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">FGFR2-2</td>
      <td>
        <font color = "#9d9e9e">
          GG
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">LOX</td>
      <td>
        <font color = "#9d9e9e">
          CC
        </font>
  ...
  <ul style="list-style-type:none; text-align: left; font-weight: 300;">
   ...
   <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
   <hr>
   <p style="font-weight: 300;" align = "center">71</p>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>卵巢癌好發於四十歲至七十歲婦女，其可能發生於任何年齡群，發生率隨年齡逐年增<br>
              高。
          </li>
          <li>常見的危險因子包含：家族遺傳、未曾懷孕生育的婦女、較晚停經的婦女、曾得過乳<br>
              癌的病人、曾受過輻射線的暴露、接觸過工業用石綿污染等。有趣的是，使用口服避<br>
              孕藥及輸卵管結紮者發生率減低。
          </li>
        </ul>
      </td>
      ...
      <td align = "center">
        每十萬人口<br>年齡標準化<br>
        <font style = "font-weight: 300;">女性 </font>
        <font size="6" color = "#5DADE2">9.18</font>
      </td>
...
<div class="disease_detail">
  ...
  <table class="table_disease_detail" FRAME="VOID" BORDER="2" RULES="ALL" style="display:inline-table;">
    ...
    <tr align = "center">
      <td style="font-weight: 300;">FSHR</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
    ...
    <tr align = "center">
      <td style="font-weight: 300;">MMP12</td>
      <td>
        <font color = "#9d9e9e">
          TT
        </font>
  ...
  <ul style="list-style-type:none; text-align: left; font-weight: 300;">
   ...
   <br>
   <hr>
   <p style="font-weight: 300;" align = "center">72</p>
     ...
     <tr>
       <td style="border-right: 1px solid #F7DC6F;">
         <ul style="font-weight: 300;">
           ...
           <li>常見的危險因子包含：部分高風險人類乳突病毒(HPV)感染、性伴侶人數、吸菸、女性<br>
               荷爾蒙、免疫缺陷等。
           </li>
         </ul>
       </td>
       ...
       <td align = "center">
         每十萬人口<br>年齡標準化<br>
         <font style = "font-weight: 300;">女性 </font>
         <font size="6" color = "#5DADE2">8.13</font>
       </td>
 ...
 <div class="disease_detail">
   ...
   <table class="table_disease_detail" FRAME="VOID" BORDER="2" RULES="ALL" style="display:inline-table;">
     ...
     <tr align="center">
       ...
       <th rowspan = "3">
         <ul style="list-style-type:none; text-align: left">
           ...
           <li style="font-weight: 100;">
               帶有高風險基因型會影響鹼基切除修復<br>
               (BER)、DNA雙鏈斷裂修復、核苷酸交<br>
               互連結等調控作用，使DNA損傷造成的<br>
               異常逐漸在體內累積。
           </li>
         </ul>
       </th>
     ...
     <tr align = "center">
       <td style="font-weight: 300;">PARP1</td>
       <td>
         <font color = "#9d9e9e">
           AA
         </font>
     ...
     <tr align = "center">
       <td style="font-weight: 300;">TLR9</td>
       <td>
         <font color = "#9d9e9e">
           AA
         </font>
 ...
 <div class="disease_detail2">
   ...
   <table class="table_disease_detail" FRAME="VOID" BORDER="2" RULES="ALL" style="display:inline-table;">
    ...
    <tr align = "center">
      <td style="font-weight: 300;" >GSDMB</td>
      <td>
        <font color = "#9d9e9e">
          AA
        </font>
    ...
    <tr align = "center">
     ...
     <td style="font-weight: 300;">CD226</td>
     <td>
       <font color = "#9d9e9e">
         AA
       </font>
   ...
   <tr align = "center">
     <td style="font-weight: 300;">OPN</td>
     <td>
       <font color = "#9d9e9e">
         TT
       </font>
   ...
   <tr align = "center">
     <td style="font-weight: 300;">EpCAM</td>
     <td>
       <font color = "#9d9e9e">
         CC
       </font>
       ...
       <tr>
         <td style="border-right: 1px solid #F7DC6F;">
           <ul style="font-weight: 300;">
             ...
             <li>常見的危險因子包含：抽菸、工作環境(如接觸化學藥劑、卡車駕駛、鉛管工、美髮師<br>
                 等)、膀胱相關發炎與感染、結石、常吃醃製、炭烤食物等。
             </li>
           </ul>
         </td>
...
<div class = "disease_top">
    ...
    <div class="disease_title">
       <table class="table_disease_tile">
        ...
        <tr>
          <td style="border-right: 1px solid #F7DC6F;">
            <ul style="font-weight: 300;">
              <li>淋巴癌是源發自淋巴組織的一種癌症。淋巴系統包括淋巴組織及器官，譬如脾臟、扁<br>
                  桃腺、淋巴球（白血病的一種）以及豆狀的淋巴結，它的功能是對抗病菌造成的感染。
              </li>
              <li>疾病發生原因不明，暴露在有機化學物質（如苯）、曾經接受過放射治療或化學治療
                  者，罹患風險較高。曾遭Ｃ型肝炎或幽門螺蜁桿菌，也較容易罹患淋巴癌。
              </li>
              <li>台灣每年新增3000個淋巴癌患者。
              </li>
            </ul>
    ...
    <div class="disease_detail">
     ...
     <div class = "disease_top">
          ...
          <img src= "../graph/綜合評估頁首右.png" alt= "tcigene_logo" align="middle" style="width:900px;height:100px;">
     ...
     <div class = "disease_title_last">
         ...
         <div class="disease_detail6">
                 ...
                 <table class="high_risk_disease" FRAME="VOID" BORDER="2" RULES="ALL">
                   ...
                   <tr>
                     <th colspan = "3" style="text-align: left">
                       ...
                       <font size = "5" style = "font-weight: 300;">&nbsp綜合高風險疾病</font>
                   ...
                   <tr align="left">
                     ...
                     <td height = "20" style = "padding-top : 10px; padding-bottom: 10px;">
                       <font face = "">
                           <?php
                               echo '<span style="font-weight: 300"> '.$disease_risk[1][1].'</span>';
                           ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[2][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[3][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[4][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[5][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[6][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[7][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[8][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[9][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[10][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[11][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[12][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[13][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[14][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[15][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[16][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[17][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
                   ...
                   <tr align="left">
                     <td height = "20" style = "padding-bottom: 10px;">
                       <font face = "">
                         <?php
                             echo '<span style="font-weight: 300"> '.$disease_risk[18][1].'</span>';
                         ?>
                       </font>
                     </td>
                   </tr>
          ...
          <div class = "disease_top">
               ...
               <img src= "../graph/綜合評估頁首左.png" alt= "tcigene_logo" align="middle" style="width:900px;height:100px;">
          ...
          <div class="disease_detail4">
            ...
            <p style="font-weight: 100;">
              &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              您在下列疾病風險皆偏高，需注意避免接觸相關危險因子。是否容易罹患疾病有三種因素：個人基因體質、外界環境、<br>
              &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              個人生活習慣，這三個危險因素交互影響是疾病產生的主因，您已了解自己的基因體質，未來大江基因會協助您做正確<br>
              &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              且有效的健康管理，延緩或避免疾病的發生，以預防醫學的方式讓您擁有更好的生活品質、更長遠的生命。
              <br><br>
            </p>
