...
<head>
  ...
  <?php
    ...
    $G2_num = $_GET['sample'];
    $path = "/Users/hou/Desktop/tci/g2_auto/result/";
    $date = substr($G2_num , 2, 6);
...
.disease_description_outer2_left {
  position: static;
  background-color: white;
  color: black;
  margin: 0px 0px 0px 32px;
...
.disease_description_outer3_left {
  position: static;
  background-color: white;
  color: black;
  margin: 0px 0px 0px 32px;
...
<?php
  ...
  $filename = $path . $date . "/" . $G2_num . "/" . $G2_num. "_membership.csv";
  //echo $filename;
  ...
  $filename = $path . $date . "/" . $G2_num . "/" . $G2_num. "_female_disease_ratio.csv";
  //echo $filename;
  ...
  //read the disease risk file
  $filename = $path . $date . "/" . $G2_num . "/" . $G2_num. "_female_risk_disease.csv";
  ...
  //read the disease risk file
  $filename = $path . $date . "/" . $G2_num . "/" . $G2_num. "_gene_risk.csv";
  ...
  //read the disease risk file
  $filename = $path . $date . "/" . $G2_num . "/" . $G2_num. "_female_nutrient_description.csv";
...
<div class = head_page>
  ...
  <form method="get" name="form" action="g2_f_p_7.php" align="middle">
    <input style="height:280px; border: 0px;" type="text" placeholder="" name="sample" size="100">
  </form>
...
<div class = "public_page">
  ...
  <p align = "right">
    <font color = "grey" size = "1" style = "font-weight: 100;">
      <?php echo $membership[1][2]; ?>
    </font> <font color = "white">TCI</font></p>
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          ...
          <li>臨床最常見的症狀是月經量增加，還可能會有骨盆腔的慢性疼痛，例如<br>
              ：痛經、性交疼痛等；若是肌瘤太大，壓迫到泌尿系統，可能造成頻尿<br>
              、解尿困難，或是腎積水；壓迫到腸子，則可能造成阻塞或便秘。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>多囊性卵巢症候群從超音波可看到卵巢腫大，卵巢出現許多小的卵泡看<br>
              起來像是小囊腫，是生殖年齡婦女最為常見的內分泌疾病。
          </li>
          <li>常見的症狀包含月經稀少、肥胖、不孕症、與男性荷爾蒙太高的表現，<br>
              例如：多毛症，青春痘很多等。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile_left">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>女性尿道感染發生主因為女性的尿道較短(五公分)，且尿道口接近陰道口<br>
              及肛門，衛生環境不注意時，細菌容易感染至膀胱或逆流至腎臟造成感染<br>
              。另外孕婦更容易得到女性尿道感染，因懷孕時子宮及胎兒會漸漸壓迫膀<br>
              胱，如尿中有細菌的情形，就容易引起尿道感染。更年期陰道上皮細胞萎<br>
              縮，好菌(乳酸桿菌)不易繁殖，陰道無法維持酸鹼度，致使容易有細菌附<br>
              著在生殖泌尿道口。因此女性尿道感染，反覆發生很常見。
          </li>
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          ...
          <li>常見的危險因子包含：家族遺傳、荷爾蒙與未曾生育或35歲以後才生第一<br>
              胎者、良性乳房瘤、肥胖者、輻射線的暴露、長期接受荷爾蒙(替代)治療<br>
              者，缺乏運動與酗酒等。
          </li>
        </ul>
      </td>
...
<div class="disease_title">
   <table class="table_disease_tile_left">
    ...
    <tr>
      <td style="border-right: 1px solid #F7DC6F;">
        <ul style="font-weight: 300;">
          <li>卵巢癌好發於四十歲至七十歲婦女，其可能發生於任何年齡群，發生率<br>
              隨年齡逐年增高。
          </li>
          <li>常見的危險因子包含：家族遺傳、未曾懷孕生育的婦女、較晚停經的婦<br>
              女、曾得過乳癌的病人、曾受過輻射線的暴露、接觸過工業用石綿污染<br>
              等。有趣的是，使用口服避孕藥及輸卵管結紮者發生率減低。
          </li>
        </ul>
      </td>
     ...
     <tr>
       <td style="border-right: 1px solid #F7DC6F;">
         <ul style="font-weight: 300;">
           ...
           <li>常見的危險因子包含：部分高風險人類乳突病毒(HPV)感染、性伴侶人數<br>
               、吸菸、女性荷爾蒙、免疫缺陷等。
           </li>
         </ul>
       </td>
    ...
    <div class="disease_detail">
     ...
     <div class = "disease_title_last">
         ...
         <div class="disease_detail6">
                 ...
                 <br><br>
                 <hr>
                 <p style="font-weight: 300;" align = "center">79</p>
             ...
             <table class="table_disease_tile_last">
              ...
              <tr align = "left">
                ...
                <td style="font-weight: 100;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  體重： <font size = "4" style="font-weight: 300;">
                          <?php if ($membership[5][2] == ""){
                                  echo "未提供";
                                } else{
                                  echo $membership[5][2];
                                }
                          ?>
                        </font> &nbsp&nbsp&nbsp公斤</td>
                <td style="font-weight: 100;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  身高： <font size = "4" style="font-weight: 300;">
                          <?php if ($membership[6][2] == ""){
                                  echo "未提供";
                                } else{
                                  echo $membership[6][2];
                                }
                          ?>
                        </font> &nbsp&nbsp&nbsp公分</td>
                <td style="font-weight: 100;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  BMI： <font size = "4" style="font-weight: 300;">
                          <?php if ($membership[5][2] == "" or $membership[6][2] == ""){
                                  echo "未提供";
                                } else{
                                  echo round($membership[5][2]/($membership[6][2]*$membership[6][2]*0.0001),1);
                                }
                          ?>
                        </font></td>
              </tr>
              ...
              <tr align = "left">
                <td style="font-weight: 100;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  理想體重： <font size = "4" style="font-weight: 300;">
                              <?php if ($membership[5][2] == "" or $membership[6][2] == ""){
                                      echo "未提供";
                                    } else{
                                      echo round(pow($membership[6][2]/100,2)*22*0.9, 0) . ' ~ ' . round(pow($membership[6][2]/100,2)*22*1.1, 0);
                                    }
                              ?>
                           </font> &nbsp&nbsp&nbsp公斤</td>
                <td style="font-weight: 100;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  ...
                  <font size = "4" style="font-weight: 300;">
                    <?php $bmi =  round($membership[5][2]/($membership[6][2]*$membership[6][2]*0.0001),1);
                          ...
                          if ($membership[5][2] == "" or $membership[6][2] == ""){
                            echo "未提供";
                          } elseif ($bmi >= 24){
                  ...
                  &nbsp&nbsp&nbsp大卡</td>
                <td style="font-weight: 100;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  每日建議水量： <font size = "4" style="font-weight: 300;">
                    <?php if ($membership[5][2] == "" or $membership[6][2] == ""){
                            echo "未提供";
                          } else{
                            echo $membership[5][2]*30;
          ...
          <div class = 'disease_description_outer'>
            ...
            <table class="table_disease_description" FRAME="VOID" BORDER="2" RULES="ALL">
             ...
             <br>
             <hr>
             <p style="font-weight: 300;" align = "center">80</p>
        ...
        <div class="disease_detail3">
          ...
          <div class = "disease_description_outer2">
            ...
            <table class="table_disease_description" FRAME="VOID" BORDER="2" RULES="ALL">
             ...
             <br><br>
             <hr>
             <p style="font-weight: 300;" align = "center">81</p>
      ...
      <div class="disease_detail3">
        ...
        <br><br>
        <div class = "disease_description_outer2_left">
          ...
          <table class="table_disease_description" FRAME="VOID" BORDER="2" RULES="ALL">
              ...
              <tr align="center">
                 ...
                 <td height="171" align = "left">
                     <font>
                         <?php
                             echo '<span style="font-weight: 100"> '.$disease_risk[9][4].'</span>';
                         ?>
                     </font>
                  </td>
                 ...
                 <tr align="center">
                    ...
                    <td height="171" align = "left">
                        <font>
                            <?php
                                echo '<span style="font-weight: 100"> '.$disease_risk[10][4].'</span>';
                            ?>
                        </font>
                     </td>
                    ...
                    <tr align="center">
                       ...
                       <td height="171" align = "left">
                           <font>
                               <?php
                                   echo '<span style="font-weight: 100"> '.$disease_risk[11][4].'</span>';
                               ?>
                           </font>
                        </td>
                       ...
                       <tr align="center">
                          ...
                          <td height="171" align = "left">
                              <font>
                                  <?php
                                      echo '<span style="font-weight: 100"> '.$disease_risk[12][4].'</span>';
                                  ?>
                              </font>
                           </td>
                          ...
                          <tr align="center">
                             ...
                             <td height="171" align = "left">
                                 <font>
                                     <?php
                                         echo '<span style="font-weight: 100"> '.$disease_risk[13][4].'</span>';
                                     ?>
                                 </font>
                              </td>
           ...
           <br>
           <hr>
           <p style="font-weight: 300;" align = "center">82</p>
        ...
        <table class="table_disease_description" FRAME="VOID" BORDER="2" RULES="ALL">
            ...
            <tr align="center">
               ...
               <td height="171" align = "left">
                   <font>
                       <?php
                           echo '<span style="font-weight: 100"> '.$disease_risk[14][4].'</span>';
                       ?>
                   </font>
                </td>
               ...
               <tr align="center">
                  ...
                  <td height="171" align = "left">
                      <font>
                          <?php
                              echo '<span style="font-weight: 100"> '.$disease_risk[15][4].'</span>';
                          ?>
                      </font>
                   </td>
                  ...
                  <tr align="center">
                     ...
                     <td height="171" align = "left">
                         <font>
                             <?php
                                 echo '<span style="font-weight: 100"> '.$disease_risk[16][4].'</span>';
                             ?>
                         </font>
                      </td>
                     ...
                     <tr align="center">
                        ...
                        <td height="171" align = "left">
                            <font>
                                <?php
                                    echo '<span style="font-weight: 100"> '.$disease_risk[17][4].'</span>';
                                ?>
                            </font>
                         </td>
                        ...
                        <tr align="center">
                           ...
                           <td height="171" align = "left">
                               <font>
                                   <?php
                                       echo '<span style="font-weight: 100"> '.$disease_risk[18][4].'</span>';
                                   ?>
                               </font>
                            </td>
         ...
         <br><br>
         <hr>
         <p style="font-weight: 300;" align = "center">83</p>
      ...
      <table class="table_disease_description" FRAME="VOID" BORDER="2" RULES="ALL">
          ...
          <tr align="center">
             ...
             <td height="171" align = "left">
                 <font>
                     <?php
                         echo '<span style="font-weight: 100"> '.$disease_risk[19][4].'</span>';
                     ?>
                 </font>
              </td>
             ...
             <tr align="center">
                ...
                <td height="171" align = "left">
                    <font>
                        <?php
                            echo '<span style="font-weight: 100"> '.$disease_risk[20][4].'</span>';
                        ?>
                    </font>
                 </td>
                ...
                <tr align="center">
                   ...
                   <td height="171" align = "left">
                       <font>
                           <?php
                               echo '<span style="font-weight: 100"> '.$disease_risk[21][4].'</span>';
                           ?>
                       </font>
                    </td>
                   ...
                   <tr align="center">
                      ...
                      <td height="171" align = "left">
                          <font>
                              <?php
                                  echo '<span style="font-weight: 100"> '.$disease_risk[22][4].'</span>';
                              ?>
                          </font>
                       </td>
                      ...
                      <tr align="center">
                         ...
                         <td height="171" align = "left">
                             <font>
                                 <?php
                                     echo '<span style="font-weight: 100"> '.$disease_risk[23][4].'</span>';
                                 ?>
                             </font>
                          </td>
       ...
       <br>
       <hr>
       <p style="font-weight: 300;" align = "center">84</p>
    ...
    <table class="table_disease_description" FRAME="VOID" BORDER="2" RULES="ALL">
        ...
        <tr align="center">
           ...
           <td height="171" align = "left">
               <font>
                   <?php
                       echo '<span style="font-weight: 100"> '.$disease_risk[24][4].'</span>';
                   ?>
               </font>
            </td>
           ...
           <tr align="center">
              ...
              <td height="171" align = "left">
                  <font>
                      <?php
                          echo '<span style="font-weight: 100"> '.$disease_risk[25][4].'</span>';
                      ?>
                  </font>
               </td>
              ...
              <tr align="center">
                 ...
                 <td height="171" align = "left">
                     <font>
                         <?php
                             echo '<span style="font-weight: 100"> '.$disease_risk[26][4].'</span>';
                         ?>
                     </font>
                  </td>
                 ...
                 <tr align="center">
                    ...
                    <td height="171" align = "left">
                        <font>
                            <?php
                                echo '<span style="font-weight: 100"> '.$disease_risk[27][4].'</span>';
                            ?>
                        </font>
                     </td>
                    ...
                    <tr align="center">
                       ...
                       <td height="171" align = "left">
                           <font>
                               <?php
                                   echo '<span style="font-weight: 100"> '.$disease_risk[28][4].'</span>';
                               ?>
                           </font>
                        </td>
     ...
     <br><br>
     <hr>
     <p style="font-weight: 300;" align = "center">85</p>
  ...
  <table class="table_disease_description" FRAME="VOID" BORDER="2" RULES="ALL">
      ...
      <tr align="center">
         ...
         <td height="171" align = "left">
             <font>
                 <?php
                     echo '<span style="font-weight: 100"> '.$disease_risk[29][4].'</span>';
                 ?>
             </font>
          </td>
         ...
         <tr align="center">
            ...
            <td height="171" align = "left">
                <font>
                    <?php
                        echo '<span style="font-weight: 100"> '.$disease_risk[30][4].'</span>';
                    ?>
                </font>
             </td>
            ...
            <tr align="center">
               ...
               <td height="171" align = "left">
                   <font>
                       <?php
                           echo '<span style="font-weight: 100"> '.$disease_risk[31][4].'</span>';
                       ?>
                   </font>
                </td>
               ...
               <tr align="center">
                  ...
                  <td height="171" align = "left">
                      <font>
                          <?php
                              echo '<span style="font-weight: 100"> '.$disease_risk[32][4].'</span>';
                          ?>
                      </font>
                   </td>
                  ...
                  <tr align="center">
                     ...
                     <td height="171" align = "left">
                         <font>
                             <?php
                                 echo '<span style="font-weight: 100"> '.$disease_risk[33][4].'</span>';
                             ?>
                         </font>
                      </td>
   ...
   <br>
   <hr>
   <p style="font-weight: 300;" align = "center">86</p>
        ...
        <div class="disease_detail5">
          ...
          <table class="table_disease_description" FRAME="VOID" BORDER="2" RULES="ALL">
           ...
           <br>
           <hr>
           <p style="font-weight: 300;" align = "center">87</p>
