...
<?php
  ...
  $filename = $path . $date . "/" . $G2_num . "/" . $G2_num. "_male_disease_ratio.csv";
  //echo $filename;
  ...
  //read the disease risk file
  $filename = $path . $date . "/" . $G2_num . "/" . $G2_num. "_male_risk_disease.csv";
  ...
  //read the disease risk file
  $filename = $path . $date . "/" . $G2_num . "/" . $G2_num. "_male_nutrient_description.csv";
...
<div class = head_page>
  ...
  <form method="get" name="form" action="g2_m_p_7.php" align="middle">
    ...
    <div class="disease_detail3">
      ...
      <div class = "disease_description_outer2">
        ...
        <table class="table_disease_description" FRAME="VOID" BORDER="2" RULES="ALL">
         ...
         <br><br>
         <hr>
         <p style="font-weight: 300;" align = "center">77</p>
  ...
  <div class="disease_detail3">
    ...
    <div class = "disease_description_outer2_left">
      ...
      <table class="table_disease_description" FRAME="VOID" BORDER="2" RULES="ALL">
       ...
       <br><br>
       <hr>
       <p style="font-weight: 300;" align = "center">78</p>
